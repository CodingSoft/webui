...
7. **Default Configuration Testing**: All vulnerability reports MUST be tested and reproducible using CodingSoft WebUI's out-of-the-box default configuration. Claims of vulnerabilities that only manifest with explicitly weakened security settings may be discarded, unless they are covered by the following exception:
...
>
> - If we suspect you used AI (but you did not disclose it to us), we will be asking tough follow-up questions to validate your understanding of the reported vulnerability and CodingSoft WebUI itself.
...
For any other immediate concerns, please create an issue in our [issue tracker](https://github.com/codingsoft-webui/codingsoft-webui/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
