...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on codingsoft-webui.
...
3. **In-Depth Understanding**: Reports must reflect a clear understanding of the codebase, how CodingSoft WebUI is used and provide specific details about the vulnerability, including the affected components and potential impacts.
...
6. **Default Configuration Testing**: All vulnerability reports must be tested and reproducible using CodingSoft WebUI's out-of-the-box default configuration. Claims of vulnerabilities that only manifest with explicitly weakened security settings may be discarded, unless they are covered by the following exception:
...
7. **Threat Model Understanding Required**: Reports must demonstrate understanding of CodingSoft WebUI's self-hosted, authenticated, extensible, role-based access control architecture. Comparing CodingSoft WebUI to services with fundamentally different security models without acknowledging the architectural differences may result in report rejection.
...
>
> - If we suspect you used AI (but you did not disclose it to us), we will be asking thorough follow-up questions to validate your understanding of the reported vulnerability and CodingSoft WebUI itself.
>
...
> - had a clear lack of understanding of CodingSoft WebUI
...
Please use the adequate channel for your specific issue - e.g. best-practice guidance or **dditional documentation needs into the [Documentation Repository](https://github.com/codingsoft-webui/docs)**, and **feature requests into the Main Repository as an issue or discussion**.
