...
- [ ] **Documentation:** Add docs in [CodingSoft WebUI Docs Repository](https://github.com/codingsoft-webui/docs). Document user-facing behavior, environment variables, public APIs/interfaces, or deployment steps.
